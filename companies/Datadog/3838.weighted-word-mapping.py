...
# weights[i] represents the weight of the i^th lowercase English letter.
#
...
# lowercase English letter using reverse alphabetical order (0 -> 'z', 1
# -> 'y', ..., 25 -> 'a').
#
...
# Explanation:
#
# The weight of "abcd" is 5 + 3 + 12 + 14 = 34. The result modulo 26 is 34
# % 26 = 8, which maps to 'r'.
#
# The weight of "def" is 14 + 1 + 2 = 17. The result modulo 26 is 17 % 26
# = 17, which maps to 'i'.
#
# The weight of "xyz" is 7 + 7 + 2 = 16. The result modulo 26 is 16 % 26 =
# 16, which maps to 'j'.
#
...
# Explanation:
#
# Each word has weight 1. The result modulo 26 is 1 % 26 = 1, which maps
# to 'y'.
#
...
class Solution:
    def mapWordWeights(self, words: List[str], weights: List[int]) -> str:
        ...
        Map each word to a letter from its character-weight sum mod 26 using
        reverse alphabet (0->'z', ..., 25->'a').

        Algorithm:
        - For each word, sum weights[ord(c)-97], take mod 26, map to chr.
