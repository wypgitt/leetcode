...
//
// @lc app=leetcode id=3914 lang=golang
//
...
// MinOperations3914 returns the minimum total cost (sum of x) of operations "add x to a subarray"
// needed to make nums non-decreasing.
func MinOperations3914(nums []int) int {
	if len(nums) == 1 {
		return 0
	}
