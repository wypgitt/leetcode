#
# @lc app=leetcode id=3521 lang=python3
#
...
#
# Identify distinct product pairs frequently purchased together by the
# same customers (where product1_id < product2_id)
#
...
class Solution:
    def solve(self) -> str:
        ...
        Find product pairs co-purchased by ≥3 distinct users; attach categories
        and rank by popularity then ids.

        Algorithm:
        - Self-join ProductPurchases on user_id with product1_id < product2_id.
        - Join ProductInfo twice for categories; GROUP BY pair; HAVING count ≥ 3.
        - ORDER BY customer_count DESC, product1_id, product2_id.

        Complexity: O(P^2) worst-case join cardinality over purchases P.
        """
        self.sql = """
SELECT
