#
# @lc app=leetcode id=1179 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Pivot monthly revenue into columns Jan_Revenue .. Dec_Revenue per id
        using conditional aggregation (CASE / IF + SUM/MAX).

        Algorithm:
        - GROUP BY id; for each month SUM(CASE WHEN month='Jan' THEN revenue END).
