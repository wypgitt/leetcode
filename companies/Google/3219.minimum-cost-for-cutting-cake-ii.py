...
class Solution:
    def minimumCost(self, m: int, n: int, horizontalCut: List[int], verticalCut: List[int]) -> int:
        ...
        Same cake-cutting cost model as I, but m,n up to 1e5 so only the greedy
        cut-order algorithm is viable.

        Algorithm:
        - Sort horizontal and vertical cut costs descending.
        - Always cut the more expensive remaining line next; multiply by the
          current number of pieces in the perpendicular direction.
