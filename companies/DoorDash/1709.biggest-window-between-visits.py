#
# @lc app=leetcode id=1709 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"UserVisits\":[\"user_id\",\"visit_date\"]},\"rows\":{\"UserVisits\":[[\"1\",\"2020-11-28\"],[\"1\",\"2020-10-20\"],[\"1\",\"2020-12-3\"],[\"2\",\"2020-10-5\"],[\"2\",\"2020-12-9\"],[\"3\",\"2020-11-11\"]]}}"
#
#
# Table: UserVisits
#
...
# This table contains logs of the dates that users visited a certain
# retailer.
#
# Assume today's date is '2021-1-1'.
#
# Write a solution that will, for each user_id, find out the largest
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL. For each user_id, biggest gap between consecutive visit_date
        values, also including the gap from the last visit to 2021-01-01.

        Algorithm:
        - LEAD(visit_date, 1, '2021-01-01') OVER (PARTITION BY user_id ORDER BY visit_date)
        - DATEDIFF(next_date, visit_date); MAX per user_id.
