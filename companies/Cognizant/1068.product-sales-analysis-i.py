#
# @lc app=leetcode id=1068 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Join Sales with Product on product_id to attach product_name to each sale,
        then project product_name, year, and price.

        Algorithm:
        - INNER JOIN Sales s WITH Product p ON s.product_id = p.product_id.
        - SELECT p.product_name, s.year, s.price.

        Complexity: O(N) join over Sales rows.
        """
        return self.sql
