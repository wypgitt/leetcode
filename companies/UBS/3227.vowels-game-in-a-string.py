...
#
# Bob plays second, he can delete the underlined substring in s = "der"
# which contains 0 vowels. The resulting string is s = "er".
#
# Alice plays third, she can delete the whole string s = "er" which
# contains 1 vowel.
#
# Bob plays fourth, since the string is empty, there is no valid play for
# Bob. So Alice wins the game.
#
# Example 2:
#
# Input: s = "bbcd"
...
class Solution:
    def doesAliceWin(self, s: str) -> bool:
        ...
        Alice removes odd-vowel substrings; Bob removes even-vowel ones. If any
        vowel exists, Alice can always force a win; with zero vowels she cannot move.

        Algorithm:
        - Return True iff s contains at least one vowel in {a,e,i,o,u}.

        Complexity: O(n) time, O(1) space.
        Alternate: count vowels; Alice wins iff count > 0.
        """
        vowels = set("aeiou")
