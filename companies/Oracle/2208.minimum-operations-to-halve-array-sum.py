...
# 14.75.
# The sum of nums has been reduced by 33 - 14.75 = 18.25, which is at least half
# of the initial sum, 18.25 >= 33/2 = 16.5.
...
class Solution:
    def halveArray(self, nums: List[int]) -> int:
        ...
        Each operation halves one element. Min ops so sum <= half original sum.

        Algorithm:
        - Max-heap; repeatedly halve the current largest until reduced enough.
