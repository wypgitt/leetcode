...
#
# The edges array is given on the form edges[i] = [a_i, b_i], which means there
...
class Solution:
    def countSubTrees(self, n: int, edges: List[List[int]], labels: str) -> List[int]:
        ...
        Undirected tree; for each node return count of nodes in its subtree
        with the same label. DFS returning Counter of labels in subtree.

        Algorithm:
        - Build adj; dfs(u,parent) merges child counters; ans[u]=cnt[labels[u]].
