...
# Explanation:
#
# We cannot form groups of k = 3 distinct elements using all values
# exactly once.
#
# Constraints:
#
...
class Solution:
    def partitionArray(self, nums: List[int], k: int) -> bool:
        ...
        Groups of size k with distinct elements ⇒ n divisible by k and no
        value appears more than the number of groups.

        Algorithm:
        - If len % k: false; else max frequency ≤ len//k.
