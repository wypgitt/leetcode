#
# @lc app=leetcode id=1327 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Products + Orders. Names of products with at least 100 units ordered
        in February 2020, with the unit total.

        Algorithm:
        - Filter order_date in Feb 2020; GROUP BY product; HAVING SUM(unit)>=100;
          join Products for name.
