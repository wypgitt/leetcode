...
# infinite supply of some fixed coin denominations. Each denomination is a
# positive integer with value at most numWays.length.
#
...
# numWays array.
#
# Return a sorted array containing unique integers which represents this
...
#                         8
#                         4
#                         The ways are [2, 2, 2, 2], [2, 2, 4], [2, 6],
# and [4, 4].
#
#                         9
#                         0
...
#                         10
#                         5
#                         The ways are [2, 2, 2, 2, 2], [2, 2, 2, 4], [2,
# 4, 4], [2, 2, 6], and [4, 6].
#
# Example 2:
#
...
#                         5
#                         4
#                         The ways are [1, 1, 1, 1, 1], [1, 1, 1, 2], [1,
# 2, 2], and [5].
#
# Example 3:
#
...
class Solution:
    def findCoins(self, numWays: List[int]) -> List[int]:
        ...
        Recover unbounded-knapsack coin set from the ways array. For amount i,
        if current DP is 1 short of numWays[i], i must be a new coin.

        Algorithm:
        - dp[0]=1; for i=1..n: if numWays[i-1]-dp[i]==1, add coin i and update dp.
        - After the update decision, require exact match; else return [].
