#
# @lc app=leetcode id=602 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Each accepted request creates an undirected friendship. Count friends per person and return the max.

        Algorithm:
        - UNION ALL requester_id and accepter_id as id.
        - GROUP BY id, COUNT(*); ORDER BY num DESC LIMIT 1.

        Complexity: O(R) over RequestAccepted.
        """
        return self.sql
