#
# @lc app=leetcode id=1211 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Per query_name: quality = AVG(rating/position), poor_query_percentage =
        percentage of queries with rating < 3.

        Algorithm:
        - GROUP BY query_name
        - ROUND(AVG(rating/position),2), ROUND(AVG(rating<3)*100,2)
