# System Design: GPU Scheduler with Credits

> **Focus areas:** Credits/quotas · Weighted fairness · Gang scheduling · Preemption · Binpack vs spread · Multi-SKU · Leases  
> **Style:** Cluster scheduler design with progressive scale (10× → 100× → 1,000×)  
> **Quality bar:** Correct arithmetic, split control-plane vs GPU-time load classes, starvation prevention, resolved ownership of credit vs placement
