...
**Note:** Overlaps from the public bank (e.g. warehouse, lockers, rate limiter, cache, Prime Video, fake reviews) are consolidated to one canonical file each. Locker **capacity allocation** and **pickup-locker software** remain separate (algorithm/reservation vs device/ops software).
