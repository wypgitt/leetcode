#
# @lc app=leetcode id=1890 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Logins(user_id, time_stamp). For each user who logged in during 2020,
        report the latest login timestamp in 2020.

        Algorithm:
        - WHERE YEAR(time_stamp)=2020 GROUP BY user_id → MAX(time_stamp).
    ...
    def solve_year(self) -> str:
        """
        Interview explanation:
        Alternate: YEAR(time_stamp) = 2020 filter.
