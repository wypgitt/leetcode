#
# @lc app=leetcode id=1280 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        For every (student, subject) pair, count how many times that student
        attended that subject's exam. CROSS JOIN Students×Subjects, LEFT JOIN
        Examinations, GROUP BY, COUNT.

        Algorithm:
        - CROSS JOIN Students and Subjects.
        - LEFT JOIN Examinations on student_id and subject_name.
        - GROUP BY student_id, student_name, subject_name; COUNT(exam rows).
        - ORDER BY student_id, subject_name.

        Complexity: O(S * Sub + E).
        """
        return self.sql
