...
//
// @lc app=leetcode id=3901 lang=golang
//
// [3901] Good Subsequence Queries
//
...
type segNode3901 struct {
	l, r int
	g    int
}

type segTree3901 struct {
	tr []*segNode3901
}

func gcd3901(a, b int) int {
	for b != 0 {
		a, b = b, a%b
	}
	if a < 0 {
...
func newSegTree3901(n int) *segTree3901 {
	t := &segTree3901{tr: make([]*segNode3901, n<<2)}
	t.build(1, 1, n)
	return t
}

func (t *segTree3901) build(u, l, r int) {
	t.tr[u] = &segNode3901{l: l, r: r}
	if l == r {
		return
	}
	mid := (l + r) >> 1
...
func (t *segTree3901) pushUp(u int) {
	t.tr[u].g = gcd3901(t.tr[u<<1].g, t.tr[u<<1|1].g)
}

func (t *segTree3901) modify(u, x, v int) {
...
func (t *segTree3901) query(u, l, r int) int {
	if l > r {
		return 0
	}
	...
	return gcd3901(t.query(u<<1, l, mid), t.query(u<<1|1, mid+1, r))
}

func (t *segTree3901) rootG() int { return t.tr[1].g }

// CountGoodSubseq3901 returns number of queries after which a good subsequence exists.
func CountGoodSubseq3901(nums []int, p int, queries [][]int) int {
	n := len(nums)
	tree := newSegTree3901(n)
	cnt := 0
