...
class Solution:
    def sortEvenOdd(self, nums: List[int]) -> List[int]:
        ...
        Sort values at even indices in non-decreasing order, and values at odd
        indices in non-increasing order; keep positions' parity.

        Algorithm:
        - Extract even/odd index values; sort even asc, odd desc; write back.
