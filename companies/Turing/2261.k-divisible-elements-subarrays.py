...
# by 1.
# Since all subarrays are distinct, the total number of subarrays satisfying all
# the constraints is 10.
#
#
#
# Constraints:
...
class Solution:
    def countDistinct(self, nums: List[int], k: int, p: int) -> int:
        ...
        Count distinct contiguous subarrays with at most k elements divisible by p.

        Algorithm:
        - Enumerate all subarrays (n<=200); track divisible count; store tuple hashes/set.
