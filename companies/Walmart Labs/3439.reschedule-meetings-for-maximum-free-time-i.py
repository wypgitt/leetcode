...
# meetings, where the i^th meeting occurs during the time [startTime[i],
# endTime[i]].
#
...
class Solution:
    def maxFreeTime(
        ...
        With order fixed, rescheduling <=k meetings merges up to k+1 consecutive
        free gaps into one free block. Maximize the sum of any window of k+1 gaps.

        Algorithm:
        - Build gaps: before first, between meetings, after last.
        - Sliding window sum of length k+1; return the maximum.
