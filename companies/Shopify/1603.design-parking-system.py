...
class ParkingSystem:
    def __init__(self, big: int, medium: int, small: int):
        ...
        Design a lot with fixed slots for car types 1/2/3 (big/medium/small).
        Track remaining capacity per type.

        Algorithm:
        - Store slots in array indexed by carType (1-based).
    ...
    def addCar(self, carType: int) -> bool:
        """
        Interview explanation:
        Park if a slot of carType remains; decrement and return True, else False.

        Algorithm:
        - If slots[carType] > 0: decrement; return True; else False.
