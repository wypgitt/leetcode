...
# Explanation
# -----------
# The custom function is strictly increasing in both x and y. Start at the
# top-left corner of the search grid: x = 1, y = 1000. If f(x, y) is too small,
# increasing x is the only way to raise it. If it is too large, decreasing y is
# the only way to lower it. When it equals z, record the pair and move both
# directions because strict monotonicity prevents another solution with the
# same x or y.
#
# This is the same idea as searching a sorted matrix from a corner. It avoids
# checking all 1,000,000 pairs.
#
# Edge cases: no solutions; solution at boundary x = 1 or y = 1000; multiple
# solutions along the monotone frontier.
#
# Time complexity: O(1000), more generally O(limit).
