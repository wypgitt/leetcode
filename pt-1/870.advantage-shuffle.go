...
// AdvantageCount870 permutes nums1 to maximize count of indices i with perm[i] > nums2[i].
//
...
func AdvantageCount870(nums1, nums2 []int) []int {
	n := len(nums1)
	...
	sort.Slice(order, func(i, j int) bool {
		if nums2[order[i]] != nums2[order[j]] {
