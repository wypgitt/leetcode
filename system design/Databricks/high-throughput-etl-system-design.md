# System Design: High-Throughput ETL Pipelines (Bronze → Gold Lakehouse)

> **Focus areas:** DAG orchestration · Shuffle/skew · Retries/idempotency · Data quality gates · SLAs · Bronze→Silver→Gold · Delta Lake MERGE/CDF  
...
> **Interview theme:** Databricks — design a production ETL platform that lands raw data, transforms it reliably at TB–PB scale, and meets freshness/completeness SLAs without melting the cluster on skew
