...
> **Focus areas:** Directory tree · Hard links · Rename atomicity · Path resolution · Inode metadata · Locking
> **Style:** End-to-end product design with progressive scale (10× → 100× → 1,000×)
> **Quality bar:** Correct arithmetic, explicit invariants, resolved ownership, honest MVP vs extreme-scale paths
> **Interview theme:** Databricks — POSIX-like hierarchical filesystem with atomic rename and path walks
...
> **Hierarchical Filesystem**: immutable chunks, CAS namespace, delta sync, explicit conflicts, ACL everywhere, cost-aware GC.
...
## More Interview Q&A — Hierarchical Filesystem
...
## Supplemental Depth Pack — Hierarchical Filesystem
...
## Scenario Runbooks — Hierarchical Filesystem
...
## Rapid-Fire Q&A — Hierarchical Filesystem
...
## Narrative Walkthrough — Hierarchical Filesystem
...
## Pre-Onsite Checklist — Hierarchical Filesystem
...
Rehearse explaining Hierarchical Filesystem to a skeptical SDM: start from customer trust, then SLO numbers, then one architecture box that owns the risk, then the kill switch. Mention what you would not build.

### Extra drill

Rehearse a 90-second progressive-scale story for Hierarchical Filesystem: 1× → 10× break → 100× cells → 1,000× specialization.
...
*End of document — Hierarchical Filesystem (SDE III)*
