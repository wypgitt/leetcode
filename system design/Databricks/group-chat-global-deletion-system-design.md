...
> **Focus areas:** Message fan-out · Global delete/retract · Concurrent sends · Cache invalidation · Ordering · Idempotency · Multi-device sync
> **Style:** End-to-end product design with progressive scale (10× → 100× → 1,000×)  
> **Quality bar:**
> **Interview theme:** Databricks — messaging HLD with delete-for-everyone semantics under concurrent sends Correct arithmetic, explicit invariants, resolved fan-out ownership, honest MVP vs extreme-scale paths
