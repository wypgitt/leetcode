...
> **Focus areas:** Async fan-out · Partial results · Timeouts/circuit breakers · Request coalescing · Cache freshness · Order+payment saga · Rate limits  
...
> **Interview theme:** Databricks — classic HLD; expands into concurrency, caching, and crash-safe commerce flows
...
QuoteRequest       → isbn, bid_cents, customer_id, idempotency_key, deadline
SellerOffer        → seller_id, price_cents, in_stock, retrieved_at, freshness
QuoteResult        → UNAVAILABLE | ABOVE_BID | ORDER_PLACED
