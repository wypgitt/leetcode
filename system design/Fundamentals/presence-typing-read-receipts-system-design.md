# System Design: Presence, typing indicators, and read receipts
...
|-----------|----------|----------|
| Job | Design **Presence, typing indicators, and read receipts** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Presence, typing indicators, and read receipts | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Presence, typing indicators, and read receipts.
...
Domain note: tailor 2–3 cases specifically to **Presence, typing indicators, and read receipts** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Presence, typing indicators, and read receipts.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Presence, typing indicators, and read receipts**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Presence, typing indicators, and read receipts".
...
Core components for **Presence, typing indicators, and read receipts**:
- **write API**
...
flowchart LR
  ...
  GW --> Svc[Stateless presencetypingreadre Service]
...
**Failure modes checklist for Presence, typing indicators, and read receipts**
...
### 5.4 Problem-specific deep notes for Presence, typing indicators, and read receipts
...
1. **Invariants** for Presence, typing indicators, and read receipts (what must never break).
...
| 16 | Which algorithms apply to Presence, typing indicators, and read receipts? | Expect discussion of: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Presence, typing indicators, and read receipts**: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat.
...
*Category: Social, communication, and collaboration · Slug: `presence-typing-read-receipts` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix — Deep dive notes for Presence, typing indicators, and read receipts
...
| Business SLI for Presence, typing indicators, and read receipts | Product truth |
...
- Cost model at 100×
- Abuse cases unique to Presence, typing indicators, and read receipts
...
*Enriched for interview drill · `presence-typing-read-receipts`*
