<!-- Adapted into Fundamentals bank from Stripe/rate-limiter-system-design.md for cross-company prep. -->

# System Design: Rate Limiter

> **Focus areas:** Token bucket · Sliding window · Distributed counters · Edge+central  
