# System Design: Sliding-window event counter

> **Focus areas:** ingestion · schema · exactly-once · warehouse/lakehouse · query · lineage
> **Style:** End-to-end design with progressive scale (10× → 100× → 1,000×)
> **Category:** Data platforms, streaming, search, and analytics
...
|-----------|----------|----------|
| Job | Design **Sliding-window event counter** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Sliding-window event counter | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Sliding-window event counter.
...
Domain note: tailor 2–3 cases specifically to **Sliding-window event counter** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Sliding-window event counter.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Sliding-window event counter**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Sliding-window event counter".
...
Section family `02-data-platforms` emphasizes: ingestion · schema · exactly-once · warehouse/lakehouse · query · lineage.
...
Core components for **Sliding-window event counter**:
- **ingest gateway**
- **streaming log**
...
**Algorithms / structures likely discussed:** watermarking, HyperLogLog / Count-Min, LSM/columnar formats, partition pruning, consistent snapshot isolation

### 3.5 Deal-breakers for this problem family
- unbounded reprocessing without checkpoints
- no schema registry
- monolithic warehouse for interactive+ETL
...
flowchart LR
  ...
  GW --> Svc[Stateless slidingwindoweventco Service]
...
**Failure modes checklist for Sliding-window event counter**
...
- Key algorithms: watermarking, HyperLogLog / Count-Min, LSM/columnar formats, partition pruning, consistent snapshot isolation
...
### 5.4 Problem-specific deep notes for Sliding-window event counter
...
1. **Invariants** for Sliding-window event counter (what must never break).
...
| 16 | Which algorithms apply to Sliding-window event counter? | Expect discussion of: watermarking, HyperLogLog / Count-Min, LSM/columnar formats, partition pruning, consistent snapshot isolation. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Sliding-window event counter**: watermarking, HyperLogLog / Count-Min, LSM/columnar formats, partition pruning, consistent snapshot isolation.
...
*Category: Data platforms, streaming, search, and analytics · Slug: `sliding-window-event-counter` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix

- Drill 1: failure mode, mitigation, metric.
- Drill 2: failure mode, mitigation, metric.
- Drill 3: failure mode, mitigation, metric.
- Drill 4: failure mode, mitigation, metric.
- Drill 5: failure mode, mitigation, metric.
- Drill 6: failure mode, mitigation, metric.
- Drill 7: failure mode, mitigation, metric.
- Drill 8: failure mode, mitigation, metric.
- Drill 9: failure mode, mitigation, metric.
- Drill 10: failure mode, mitigation, metric.
- Drill 11: failure mode, mitigation, metric.
- Drill 12: failure mode, mitigation, metric.
- Drill 13: failure mode, mitigation, metric.
- Drill 14: failure mode, mitigation, metric.
- Drill 15: failure mode, mitigation, metric.
- Drill 16: failure mode, mitigation, metric.
- Drill 17: failure mode, mitigation, metric.
- Drill 18: failure mode, mitigation, metric.
- Drill 19: failure mode, mitigation, metric.
- Drill 20: failure mode, mitigation, metric.
- Drill 21: failure mode, mitigation, metric.
- Drill 22: failure mode, mitigation, metric.
- Drill 23: failure mode, mitigation, metric.
- Drill 24: failure mode, mitigation, metric.
- Drill 25: failure mode, mitigation, metric.
- Drill 26: failure mode, mitigation, metric.
- Drill 27: failure mode, mitigation, metric.
- Drill 28: failure mode, mitigation, metric.
- Drill 29: failure mode, mitigation, metric.
- Drill 30: failure mode, mitigation, metric.
- Drill 31: failure mode, mitigation, metric.
- Drill 32: failure mode, mitigation, metric.
- Drill 33: failure mode, mitigation, metric.
- Drill 34: failure mode, mitigation, metric.
- Drill 35: failure mode, mitigation, metric.
- Drill 36: failure mode, mitigation, metric.
- Drill 37: failure mode, mitigation, metric.
- Drill 38: failure mode, mitigation, metric.
- Drill 39: failure mode, mitigation, metric.
- Drill 40: failure mode, mitigation, metric.
- Drill 41: failure mode, mitigation, metric.
- Drill 42: failure mode, mitigation, metric.
- Drill 43: failure mode, mitigation, metric.
- Drill 44: failure mode, mitigation, metric.
- Drill 45: failure mode, mitigation, metric.
- Drill 46: failure mode, mitigation, metric.
- Drill 47: failure mode, mitigation, metric.
- Drill 48: failure mode, mitigation, metric.
- Drill 49: failure mode, mitigation, metric.
- Drill 50: failure mode, mitigation, metric.
- Drill 51: failure mode, mitigation, metric.
- Drill 52: failure mode, mitigation, metric.
- Drill 53: failure mode, mitigation, metric.
- Drill 54: failure mode, mitigation, metric.
- Drill 55: failure mode, mitigation, metric.
- Drill 56: failure mode, mitigation, metric.
- Drill 57: failure mode, mitigation, metric.
- Drill 58: failure mode, mitigation, metric.
- Drill 59: failure mode, mitigation, metric.
- Drill 60: failure mode, mitigation, metric.
- Drill 61: failure mode, mitigation, metric.
- Drill 62: failure mode, mitigation, metric.
- Drill 63: failure mode, mitigation, metric.
- Drill 64: failure mode, mitigation, metric.
- Drill 65: failure mode, mitigation, metric.
- Drill 66: failure mode, mitigation, metric.
- Drill 67: failure mode, mitigation, metric.
- Drill 68: failure mode, mitigation, metric.
- Drill 69: failure mode, mitigation, metric.
- Drill 70: failure mode, mitigation, metric.
- Drill 71: failure mode, mitigation, metric.
- Drill 72: failure mode, mitigation, metric.
- Drill 73: failure mode, mitigation, metric.
- Drill 74: failure mode, mitigation, metric.
- Drill 75: failure mode, mitigation, metric.
- Drill 76: failure mode, mitigation, metric.
- Drill 77: failure mode, mitigation, metric.
- Drill 78: failure mode, mitigation, metric.
- Drill 79: failure mode, mitigation, metric.

*Enriched · `sliding-window-event-counter`*
