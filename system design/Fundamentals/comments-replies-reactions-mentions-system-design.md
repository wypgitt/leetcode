# System Design: Comments, replies, reactions, and mentions
...
|-----------|----------|----------|
| Job | Design **Comments, replies, reactions, and mentions** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Comments, replies, reactions, and mentions | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Comments, replies, reactions, and mentions.
...
Domain note: tailor 2–3 cases specifically to **Comments, replies, reactions, and mentions** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Comments, replies, reactions, and mentions.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Comments, replies, reactions, and mentions**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Comments, replies, reactions, and mentions".
...
Core components for **Comments, replies, reactions, and mentions**:
- **write API**
...
flowchart LR
  ...
  GW --> Svc[Stateless commentsrepliesreact Service]
...
**Failure modes checklist for Comments, replies, reactions, and mentions**
...
### 5.4 Problem-specific deep notes for Comments, replies, reactions, and mentions
...
1. **Invariants** for Comments, replies, reactions, and mentions (what must never break).
...
| 16 | Which algorithms apply to Comments, replies, reactions, and mentions? | Expect discussion of: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Comments, replies, reactions, and mentions**: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat.
...
*Category: Social, communication, and collaboration · Slug: `comments-replies-reactions-mentions` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix — Deep dive notes for Comments, replies, reactions, and mentions
...
| Business SLI for Comments, replies, reactions, and mentions | Product truth |
...
- Cost model at 100×
- Abuse cases unique to Comments, replies, reactions, and mentions
...
*Enriched for interview drill · `comments-replies-reactions-mentions`*
