# System Design: Helpdesk or customer-support ticketing system
...
|-----------|----------|----------|
| Job | Design **Helpdesk or customer-support ticketing system** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Helpdesk or customer-support ticketing system | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Helpdesk or customer-support ticketing system.
...
Domain note: tailor 2–3 cases specifically to **Helpdesk or customer-support ticketing system** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Helpdesk or customer-support ticketing system.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Helpdesk or customer-support ticketing system**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Helpdesk or customer-support ticketing system".
...
Core components for **Helpdesk or customer-support ticketing system**:
- **authN/authZ**
- **tenant router**
- **workflow engine**
- **audit log**
...
flowchart LR
  ...
  GW --> Svc[Stateless helpdeskticketing Service]
...
**Failure modes checklist for Helpdesk or customer-support ticketing system**
...
### 5.4 Problem-specific deep notes for Helpdesk or customer-support ticketing system
...
1. **Invariants** for Helpdesk or customer-support ticketing system (what must never break).
...
| 16 | Which algorithms apply to Helpdesk or customer-support ticketing system? | Expect discussion of: policy evaluation, hierarchical ACLs, outbox, cursor pagination, SCIM sync. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Helpdesk or customer-support ticketing system**: policy evaluation, hierarchical ACLs, outbox, cursor pagination, SCIM sync.
...
*Category: Enterprise SaaS, identity, and workflow products · Slug: `helpdesk-ticketing` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix — Deep dive notes for Helpdesk or customer-support ticketing system
...
| Business SLI for Helpdesk or customer-support ticketing system | Product truth |
...
- Cost model at 100×
- Abuse cases unique to Helpdesk or customer-support ticketing system
...
*Enriched for interview drill · `helpdesk-ticketing`*
