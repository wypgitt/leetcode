# System Design: Twitch/YouTube live comments
...
|-----------|----------|----------|
| Job | Design **Twitch/YouTube live comments** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Twitch/YouTube live comments | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Twitch/YouTube live comments.
...
Domain note: tailor 2–3 cases specifically to **Twitch/YouTube live comments** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Twitch/YouTube live comments.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Twitch/YouTube live comments**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Twitch/YouTube live comments".
...
Core components for **Twitch/YouTube live comments**:
- **write API**
...
flowchart LR
  ...
  GW --> Svc[Stateless twitchyoutubelivecom Service]
...
**Failure modes checklist for Twitch/YouTube live comments**
...
### 5.4 Problem-specific deep notes for Twitch/YouTube live comments
...
1. **Invariants** for Twitch/YouTube live comments (what must never break).
...
| 16 | Which algorithms apply to Twitch/YouTube live comments? | Expect discussion of: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Twitch/YouTube live comments**: push/pull hybrid fanout, OT/CRDT, graph BFS sampling, score ranking, ring buffers for live chat.
...
*Category: Social, communication, and collaboration · Slug: `twitch-youtube-live-comments` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix — Deep dive notes for Twitch/YouTube live comments
...
| Business SLI for Twitch/YouTube live comments | Product truth |
...
- Cost model at 100×
- Abuse cases unique to Twitch/YouTube live comments
...
*Enriched for interview drill · `twitch-youtube-live-comments`*
