# System Design: Workflow-automation product like Zapier
...
|-----------|----------|----------|
| Job | Design **Workflow-automation product like Zapier** as a production system | A toy single-process demo without failure modes |
...
|---|-----------------|---------------------------|--------------------|
| F1 | Who are the users / clients? | End users, internal services, or both for Workflow-automation product like Zapier | Authn model, SLAs, multi-tenant vs single-tenant |
...
1. Core create/read (and critical update/delete) path for Workflow-automation product like Zapier.
...
Domain note: tailor 2–3 cases specifically to **Workflow-automation product like Zapier** in the interview (the table above is the baseline set).
...
- Compliance? PII/PHI/PCI as applicable to Workflow-automation product like Zapier.
- Team size / time? Design for evolution, not big-bang perfection.
- Read-your-writes required? Default yes for owner reads.

**Scope statement to repeat back:**

> Design **Workflow-automation product like Zapier**: MVP correctness and durability first, then a clean path through 10× / 100× / 1,000× with explicit trade-offs on consistency, caching, sharding, and failure modes. Defer adjacent products unless requested.
...
```text
Assume baseline peak read QPS R, write QPS W for "Workflow-automation product like Zapier".
...
Core components for **Workflow-automation product like Zapier**:
- **authN/authZ**
- **tenant router**
- **workflow engine**
- **audit log**
...
flowchart LR
  ...
  GW --> Svc[Stateless workflowautomationza Service]
...
**Failure modes checklist for Workflow-automation product like Zapier**
...
### 5.4 Problem-specific deep notes for Workflow-automation product like Zapier
...
1. **Invariants** for Workflow-automation product like Zapier (what must never break).
...
| 16 | Which algorithms apply to Workflow-automation product like Zapier? | Expect discussion of: policy evaluation, hierarchical ACLs, outbox, cursor pagination, SCIM sync. Explain complexity and failure modes, not just names. |
...
Expect to whiteboard or verbally justify structures relevant to **Workflow-automation product like Zapier**: policy evaluation, hierarchical ACLs, outbox, cursor pagination, SCIM sync.
...
*Category: Enterprise SaaS, identity, and workflow products · Slug: `workflow-automation-zapier` · Use this as a living checklist; customize numbers with the interviewer.*

## Appendix — Deep dive notes for Workflow-automation product like Zapier
...
| Business SLI for Workflow-automation product like Zapier | Product truth |
...
- Cost model at 100×
- Abuse cases unique to Workflow-automation product like Zapier
...
*Enriched for interview drill · `workflow-automation-zapier`*
