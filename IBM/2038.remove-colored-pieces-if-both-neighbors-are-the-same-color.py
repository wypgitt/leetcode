...
class Solution:
    def winnerOfGame(self, colors: str) -> bool:
        ...
        Alice removes 'A' with both neighbors 'A'; Bob removes 'B' similarly.
        Moves do not interfere across colors; Alice wins if she has more moves.

        Algorithm:
        - Count removable AAA runs for Alice and BBB for Bob; return alice > bob.
