#
# @lc app=leetcode id=1148 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Authors who viewed at least one of their own articles (author_id = viewer_id).

        Algorithm:
        - SELECT DISTINCT author_id AS id WHERE author_id = viewer_id ORDER BY id.
