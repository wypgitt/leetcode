...
# by 4.
# Operation 3: Select i = 2, so nums becomes [1,2,1,3,3]. Your score increases
# by 3.
...
class Solution:
    def maxKelements(self, nums: List[int], k: int) -> int:
        ...
        Exactly k times: pick an element, add it to score, replace with
        ceil(x/3). Maximize total score.

        Algorithm:
        - Max-heap; always take current largest, push ceil(x/3) back.
