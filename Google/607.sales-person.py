#
# @lc app=leetcode id=607 lang=python3
#
# [607] Sales Person
#
...
# salesperson John and Pam have sales to company RED, so we report all the
# other names in the table salesperson.
#
...
class Solution:
    def solve(self) -> str:
        ...
        Salespeople who never sold to company RED.

        Algorithm:
        - Find sales_id with orders to RED via Orders⋈Company.
        - SELECT name from SalesPerson whose sales_id NOT IN that set.
