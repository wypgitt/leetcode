#
# @lc app=leetcode id=2990 lang=python3
#
# [2990] Loan Types
#
...
# Testcase Example:  "{\"headers\":{\"Loans\":[\"loan_id\",\"user_id\",\"loan_type\"]},\"rows\":{\"Loans\":[[683,101,\"Mortgage\"],[218,101,\"AutoLoan\"],[802,101,\"Inschool\"],[593,102,\"Mortgage\"],[138,102,\"Refinance\"],[294,102,\"Inschool\"],[308,103,\"Refinance\"],[389,104,\"Mortgage\"]]}}"
#
#
# Table: Loans
#
...
# - User_id 103 has a loan type of Refinance but lacks a Mortgage loan
# type, so user_id 103 won't be considered.
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Loans(loan_id, user_id, loan_type). Distinct users who have
        at least one Refinance and at least one Mortgage. Order by user_id ASC.

        Algorithm:
        - GROUP BY user_id HAVING SUM(type='Refinance')>0 AND SUM(type='Mortgage')>0.
