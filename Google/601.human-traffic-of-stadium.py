#
# @lc app=leetcode id=601 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Rows with people >= 100 that belong to a run of 3+ consecutive ids.

        Algorithm:
        - Filter people >= 100.
        - Gap technique: id - ROW_NUMBER() is constant on consecutive ids.
        - Keep groups with COUNT(*) >= 3; order by visit_date.

        Complexity: O(N) with window functions.
        """
        return self.sql
