...
class Solution:
    def minimumSum(self, num: int) -> int:
        ...
        Split a 4-digit number into two new numbers (using all digits) to
        minimize their sum. Optimal: sort digits ascending; pair smallest with
        largest as tens/ones of the two numbers.

        Algorithm:
        (sort digits)
        - Sort digits a<=b<=c<=d; return 10*a+c + 10*b+d.
