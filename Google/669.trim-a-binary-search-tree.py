...
class Solution:
    def trimBST(self, root: Optional[TreeNode], low: int, high: int) -> Optional[TreeNode]:
        ...
        BST property: if root.val < low, discard left and trim right; if
        root.val > high, discard right and trim left; else keep root and trim
        both subtrees.

        Algorithm:
        - Recurse as above; reattach trimmed children when root is in range.
