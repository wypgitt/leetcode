...
# Testcase Example:  "3\n3\n[[0,0]]"
#
# You are given two integers m and n representing the dimensions of
# a 0-indexed m x n grid.
#
...
# 1 contains the coordinates [x, y], [x + 1, y], [x, y + 1], and [x + 1, y + 1].
#
...
# cell [0,0].
# The other 3 blocks start with cells [0,1], [1,0] and [1,1]. They all have zero
# black cells.
...
class Solution:
    def countBlackBlocks(
        ...
        Count 2x2 blocks with exactly 0..4 black cells. coordinates lists black cells.

        Algorithm:
        - Each black cell contributes to up to four 2x2 blocks (top-left corners).
        - Count blocks by black-cell multiplicity; ans[0] = total blocks - touched.

        Complexity: O(|coordinates|) time, O(|coordinates|) space.
        """
        cnt: Counter = Counter()
