...
class Solution:
    def findComplement(self, num: int) -> int:
        ...
        Flip all bits in the binary representation of num (without leading
        zeros). XOR with a mask of the same bit length (all 1s).

        Algorithm:
        - mask = (1 << num.bit_length()) - 1; return num ^ mask.
