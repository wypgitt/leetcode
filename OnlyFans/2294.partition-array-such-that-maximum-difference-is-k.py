...
# is 3 - 1 = 2.
# The difference between the maximum and minimum value in the second subsequence
# is 6 - 5 = 1.
...
# The difference between the maximum and minimum value in the first subsequences
# is 2 - 2 = 0.
# The difference between the maximum and minimum value in the second
# subsequences is 4 - 4 = 0.
# The difference between the maximum and minimum value in the third subsequences
# is 5 - 5 = 0.
...
class Solution:
    def partitionArray(self, nums: List[int], k: int) -> int:
        ...
        Min subsequences so max-min in each <= k (partition into groups).

        Algorithm:
        - Sort; greedily start new group when nums[i]-start > k.
