...
class Solution:
    def findDuplicate(self, paths: List[str]) -> List[List[str]]:
        ...
        Group file paths by content. Files with the same content are duplicates;
        return groups of size >= 2.

        Algorithm:
        - Parse each "dir file(content) ..." string.
        - Map content -> list of "dir/file".
        - Return lists with length >= 2.
