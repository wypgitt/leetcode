...
# contain digits, lowercase letters, and the dollar sign '$'. A word represents
# a price if it is a sequence of digits preceded by a dollar sign.
#
#
# For example, "$100", "$23", and "$6" represent prices while "100", "$", and
# "$1e5" do not.
#
# You are given a string sentence representing a sentence and an integer
# discount. For each word representing a price, apply a discount of discount% on
...
class Solution:
    def discountPrices(self, sentence: str, discount: int) -> str:
        ...
        Words that are prices ($ + digits) get discount%; format with 2 decimals.

        Algorithm:
        - Split words; if word matches dollar+digits, replace with discounted price.
        ...
        return " ".join(conv(w) for w in sentence.split(" "))
# @lc code=end
