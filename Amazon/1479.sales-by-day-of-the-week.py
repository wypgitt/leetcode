#
# @lc app=leetcode id=1479 lang=python3
#
...
# Testcase Example:  "{\"headers\": {\"Orders\": [\"order_id\", \"customer_id\", \"order_date\", \"item_id\", \"quantity\"], \"Items\": [\"item_id\", \"item_name\", \"item_category\"]}, \"rows\": {\"Orders\": [[1, 1, \"2020-06-01\", 1, 10], [2, 1, \"2020-06-08\", 2, 10], [3, 2, \"2020-06-02\", 1, 5], [4, 3, \"2020-06-03\", 3, 5], [5, 4, \"2020-06-04\", 4, 1], [6, 4, \"2020-06-05\", 5, 5], [7, 5, \"2020-06-05\", 1, 10], [8, 5, \"2020-06-14\", 4, 5], [9, 5, \"2020-06-21\", 3, 5]], \"Items\": [[1, \"LC Alg. Book\", \"Book\"], [2, \"LC DB. Book\", \"Book\"], [3, \"LC SmarthPhone\", \"Phone\"], [4, \"LC Phone 2020\", \"Phone\"], [5, \"LC SmartGlass\", \"Glasses\"], [6, \"LC T-Shirt XL\", \"T-shirt\"]]}}"
#
#
# Table: Orders
#
...
# | quantity      | int     |
# +---------------+---------+
# (ordered_id, item_id) is the primary key (combination of columns with
# unique values) for this table.
# This table contains information on the orders placed.
# order_date is the date item_id was ordered by the customer with id
# customer_id.
#
# Table: Items
#
...
# 2) and 5 units in Glasses (ids: 5).
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL. Orders(order_id, customer_id, order_date, item_id,
        quantity), Items(item_id, item_name, item_category). Pivot quantity
        sold per category by day of week (Mon..Sun). Categories with 0 sales
        still appear.

        Algorithm:
        - LEFT JOIN Items to Orders; GROUP BY category; SUM CASE DAYNAME /
          WEEKDAY for each day column.
