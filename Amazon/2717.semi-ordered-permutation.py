...
# number equals n. You can perform the below operation as many times as you want
# until you make nums a semi-ordered permutation:
#
#
...
class Solution:
    def semiOrderedPermutation(self, nums: List[int]) -> int:
        ...
        Adjacent swaps to make 1 at front and n at end; minimize swaps.

        Algorithm:
        - Find indices of 1 and n. Cost = i1 + (n-1-in); if 1 is right of n, subtract 1
          (their swap is shared).
