#
# @lc app=leetcode id=1084 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Products sold only in Q1 2019 (2019-01-01 .. 2019-03-31 inclusive):
        every sale_date for the product lies in that window.

        Algorithm:
        - JOIN Product⋈Sales; GROUP BY product.
        - HAVING MIN(sale_date) >= '2019-01-01' AND MAX(sale_date) <= '2019-03-31'.

        Complexity: O(S) aggregation.
        """
        return self.sql
