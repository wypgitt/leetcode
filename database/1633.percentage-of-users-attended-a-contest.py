#
# @lc app=leetcode id=1633 lang=python3
#
...
#
# Return the result table ordered by percentage in descending order. In case of
# a tie, order it by contest_id in ascending order.
#
...
class Solution:
    def solve(self) -> str:
        ...
        SQL. For each contest, percentage of users registered = count/total*100.

        Algorithm:
        - GROUP BY contest_id; ROUND(COUNT*100/(SELECT COUNT FROM Users),2);
