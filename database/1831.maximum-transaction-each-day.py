#
# @lc app=leetcode id=1831 lang=python3
#
...
# Testcase Example:  "{\"headers\": {\"Transactions\": [\"transaction_id\", \"day\", \"amount\"]}, \"rows\": {\"Transactions\": [[8, \"2021-4-3 15:57:28\", 57], [9, \"2021-4-28 08:47:25\", 21], [1, \"2021-4-29 13:28:30\", 58], [5, \"2021-4-28 16:39:59\", 40], [6, \"2021-4-29 23:39:28\", 58]]}}"
#
#
# Table: Transactions
#
...
# transaction with ID 5 has an amount of 40, while the transaction with ID
# 9 has an amount of 21. We only include the transaction with ID 5 as it
# has the maximum amount this day.
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL. Return transaction_ids of max amount each day; order by id.

        Algorithm:
        - Window MAX(amount) OVER (PARTITION BY DATE(day)); filter equals; ORDER BY id.

        Complexity: O(n log n) sort/window.
        """
        return self.sql
