#
# @lc app=leetcode id=3055 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"Fraud\":[\"policy_id\",\"state\",\"fraud_score\"]},\"rows\":{\"Fraud\":[[1,\"California\",0.92],[2,\"California\",0.68],[3,\"California\",0.17],[4,\"New York\",0.94],[5,\"New York\",0.81],[6,\"New York\",0.77],[7,\"Texas\",0.98],[8,\"Texas\",0.97],[9,\"Texas\",0.96],[10,\"Florida\",0.97],[11,\"Florida\",0.98],[12,\"Florida\",0.78],[13,\"Florida\",0.88],[14,\"Florida\",0.66]]}}"
#
#
# Table: Fraud
#
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Fraud(policy_id, state, fraud_score). Per state, keep claims
        in the top 5% by fraud_score. Order by state ASC, score DESC, policy_id ASC.

        Algorithm:
        - PERCENT_RANK() PARTITION BY state ORDER BY fraud_score DESC; keep pr <= 0.05.
