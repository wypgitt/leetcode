#
# @lc app=leetcode id=1587 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Users(account, name) and Transactions(trans_id, account, amount,
        transacted_on). Balance = SUM(amount); report name and balance where
        balance > 10000.

        Algorithm:
        - JOIN Users u JOIN Transactions t ON account; GROUP BY account/name;
