#
# @lc app=leetcode id=2986 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"Transactions\":[\"user_id\",\"spend\",\"transaction_date\"]},\"rows\":{\"Transactions\":[[1,65.56,\"2023-11-18 13:49:42\"],[1,96.0,\"2023-11-30 02:47:26\"],[1,7.44,\"2023-11-02 12:15:23\"],[1,49.78,\"2023-11-12 00:13:46\"],[2,40.89,\"2023-11-21 04:39:15\"],[2,100.44,\"2023-11-20 07:39:34\"],[3,37.33,\"2023-11-03 06:22:02\"],[3,13.89,\"2023-11-11 16:00:14\"],[3,7.0,\"2023-11-29 22:32:36\"]]}}"
#
#
# Table: Transactions
#
...
# +---------+-------------------------+------------------------+
# Explanation
# - For user_id 1, their third transaction occurred on 2023-11-18 at
# 13:49:42 with an amount of $65.56, surpassing the expenditures of the
# previous two transactions which were $7.44 on 2023-11-02 at 12:15:23 and
# $49.78 on 2023-11-12 at 00:13:46. Thus, this third transaction will be
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Transactions(user_id, spend, transaction_date). For each
        user with >= 3 transactions, keep the 3rd (by time) only if its spend
        is strictly greater than both preceding spends. Order by user_id.

        Algorithm:
        - RANK() by transaction_date per user; LAG(spend) and LAG(spend,2);
          filter rank=3 and spend > both lags.
