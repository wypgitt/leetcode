#
# @lc app=leetcode id=2372 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"Salesperson\":[\"salesperson_id\",\"name\"],\"Customer\":[\"customer_id\",\"salesperson_id\"],\"Sales\":[\"sale_id\",\"customer_id\",\"price\"]},\"rows\":{\"Salesperson\":[[1,\"Alice\"],[2,\"Bob\"],[3,\"Jerry\"]],\"Customer\":[[1,1],[2,1],[3,2]],\"Sales\":[[1,2,892],[2,1,354],[3,3,988],[4,3,856]]}}"
#
#
# Table: Salesperson
#
...
# Each row in this table shows ID of a customer and the price they paid
# for the sale with sale_id.
#
# Write a solution to report the sum of prices paid by the customers of
# each salesperson. If a salesperson does not have any customers, the
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Salesperson, Customer, Sales. For each salesperson report
        sum of sale prices of their customers (0 if none).

        Algorithm:
        - LEFT JOIN Customer and Sales; GROUP BY salesperson; IFNULL(SUM,0).
