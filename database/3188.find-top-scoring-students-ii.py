#
# @lc app=leetcode id=3188 lang=python3
#
...
# Each row contains the course ID, course name, credits, major it belongs
# to, and whether the course is mandatory.
#
# Table: enrollments
#
# +-------------+----------+
...
# Probability and Statistics as electives, receiving an A and B
# respectively.
#
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL II: all mandatory major courses with grade A, >=2 electives
        in major with grade A/B, and AVG(GPA) >= 2.5 over all enrollments.

        Algorithm:
        - CTE of students with AVG(GPA) >= 2.5.
        - JOIN major courses; LEFT JOIN enrollments; HAVING checks for
          mandatory A counts and elective A/B counts (>=2).
