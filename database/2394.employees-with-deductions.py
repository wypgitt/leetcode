#
# @lc app=leetcode id=2394 lang=python3
#
...
# Testcase Example:  "{\"headers\": {\"Employees\": [\"employee_id\", \"needed_hours\"], \"Logs\": [\"employee_id\", \"in_time\", \"out_time\"]}, \"rows\": {\"Employees\": [[1, 20], [2, 12], [3, 2]], \"Logs\": [[1, \"2022-10-01 09:00:00\", \"2022-10-01 17:00:00\"],[1, \"2022-10-06 09:05:04\", \"2022-10-06 17:09:03\"], [1, \"2022-10-12 23:00:00\", \"2022-10-13 03:00:01\"], [2, \"2022-10-29 12:00:00\", \"2022-10-29 23:58:58\"]]}}"
#
#
# Table: Employees
#
...
# | out_time    | datetime |
# +-------------+----------+
# (employee_id, in_time, out_time) is the primary key (combination of
...
# month. Employees work in sessions. The number of hours an employee
# worked can be calculated from the sum of the number of minutes the
# employee worked in all of their sessions. The number of minutes in each
# session is rounded up.
#
# For example, if the employee worked for 51 minutes and 2 seconds in a
# session, we consider it 52 minutes.
#
# Write a solution to report the IDs of the employees that will be
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Employees(employee_id, needed_hours), Logs(employee_id,
        in_time, out_time). Session minutes = CEIL(seconds/60). Report employees
        whose total hours < needed_hours (including no logs).

        Algorithm:
        - Aggregate CEILING(TIMESTAMPDIFF(second)/60)/60 per employee; LEFT JOIN;
          filter tot < needed_hours.
