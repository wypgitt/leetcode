#
# @lc app=leetcode id=3358 lang=python3
#
...
#
# Write a solution to find all books that have not been rated yet (i.e.,
# have a NULL rating).
#
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: books with NULL rating; return book_id, title, author,
        published_year ordered by book_id ASC.

        Algorithm:
        - SELECT ... WHERE rating IS NULL ORDER BY book_id.
