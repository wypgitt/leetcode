#
# @lc app=leetcode id=3580 lang=python3
#
...
#
# Return the result table ordered by improvement score in descending
...
#
# The output table is ordered by improvement_score in descending order,
...
class Solution:
    def solve(self) -> str:
        ...
        For each employee take the three most recent reviews; require strictly
        increasing ratings; improvement_score = latest - earliest of those three.

        Algorithm:
        - ROW_NUMBER() OVER (PARTITION BY employee_id ORDER BY review_date DESC).
        - Keep rn ≤ 3; require COUNT = 3 and r3 < r2 < r1 (by date order).
...
WHERE l.cnt = 3 AND l.r3 < l.r2 AND l.r2 < l.r1
