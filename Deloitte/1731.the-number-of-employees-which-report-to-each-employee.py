#
# @lc app=leetcode id=1731 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        For each manager, report employee_id, name, reports_count, average age
        of direct reports (rounded).

        Algorithm:
        - Join Employees to itself on reports_to; GROUP BY manager; COUNT, ROUND(AVG).
