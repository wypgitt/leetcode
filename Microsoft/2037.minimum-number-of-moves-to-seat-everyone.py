...
# array seats of length n, where seats[i] is the position of the i^th seat. You
...
class Solution:
    def minMovesToSeat(self, seats: List[int], students: List[int]) -> int:
        ...
        Assign each student to a unique seat; move cost |seat-student|. Minimize
        total moves — sort both and pair greedily.

        Algorithm:
        - Sort seats and students; sum absolute differences.
