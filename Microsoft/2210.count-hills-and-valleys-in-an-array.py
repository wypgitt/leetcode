...
class Solution:
    def countHillValley(self, nums: List[int]) -> int:
        ...
        Hill/valley at i if closest non-equal neighbors are both smaller/larger.
        Equal adjacent indices count as one hill/valley.

        Algorithm:
        - Compress equal runs; count strict local max/min in the compressed array.
