...
# respectively. The sum is 6.
# - Substrings of length 3: "cod", "ode" have an appeal of 3 and 3 respectively.
# The sum is 6.
...
class Solution:
    def appealSum(self, s: str) -> int:
        ...
        Appeal of substring = #distinct chars. Sum appeal over all substrings.

        Algorithm:
        - For each position i, contribution of s[i] is (i - last[s[i]]) * (n - i)
          as new distinct endings; accumulate with running total of distincts.
