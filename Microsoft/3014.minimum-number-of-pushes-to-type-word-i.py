...
class Solution:
    def minimumPushes(self, word: str) -> int:
        ...
        Remap 8 keys (2-9); letters are distinct. Assign letters round-robin so
        the first 8 cost 1 push, next 8 cost 2, etc.

        Algorithm:
        - For i-th letter (0-based) in any order, cost is i // 8 + 1.
        - Sum over all letters in word.

        Complexity: O(|word|) time, O(1) space.
        """
