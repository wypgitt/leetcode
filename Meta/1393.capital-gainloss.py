#
# @lc app=leetcode id=1393 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"Stocks\":[\"stock_name\",\"operation\",\"operation_day\",\"price\"]},\"rows\":{\"Stocks\":[[\"Leetcode\",\"Buy\",1,1000],[\"Corona Masks\",\"Buy\",2,10],[\"Leetcode\",\"Sell\",5,9000],[\"Handbags\",\"Buy\",17,30000],[\"Corona Masks\",\"Sell\",3,1010],[\"Corona Masks\",\"Buy\",4,1000],[\"Corona Masks\",\"Sell\",5,500],[\"Corona Masks\",\"Buy\",6,1000],[\"Handbags\",\"Sell\",29,7000],[\"Corona Masks\",\"Sell\",10,10000]]}}"
#
# Table: Stocks
#
# +---------------+---------+
...
# | price | int |
# +---------------+---------+
# (stock_name, operation_day) is the primary key (combination of columns with
...
# 1010$. It was bought again at day 4 for 1000$ and was sold at day 5 for 500$.
# At last, it was bought at day 6 for 1000$ and was sold at day 10 for 10000$.
# Capital gain/loss is the sum of capital gains/losses for each ('Buy' -->
# 'Sell') operation = (1010 - 10) + (500 - 1000) + (10000 - 1000) = 1000 - 500
# + 9000 = 9500$.
#
...
class Solution:
    def solve(self) -> str:
        ...
        Capital gain/loss per stock = sum(sell prices) - sum(buy prices).

        Algorithm:
        - GROUP BY stock_name; SUM(CASE WHEN operation='Buy' THEN -price ELSE price)

        Complexity: O(n) aggregate.
        """
        return self.sql
