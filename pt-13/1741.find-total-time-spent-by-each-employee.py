...
# Testcase Example:  "{\"headers\":{\"Employees\":[\"emp_id\",\"event_day\",\"in_time\",\"out_time\"]},\"rows\":{\"Employees\":[[\"1\",\"2020-11-28\",\"4\",\"32\"],[\"1\",\"2020-11-28\",\"55\",\"200\"],[\"1\",\"2020-12-3\",\"1\",\"42\"],[\"2\",\"2020-11-28\",\"3\",\"33\"],[\"2\",\"2020-12-9\",\"47\",\"74\"]]}}"
#
# Table: Employees
#
# +-------------+------+
...
class Solution:
    def solve(self) -> str:
        ...
        Algorithm:
        - GROUP BY event_day, emp_id; SUM(out_time - in_time) AS total_time.
