#
# @lc app=leetcode id=3705 lang=python3
#
...
# order_rating is between 1 and 5, where 5 is the best (NULL if not
# rated).
# order_timestamp contains both date and time information.
#
# Write a solution to find golden hour customers - customers who
# consistently order during peak hours and provide high satisfaction. A
# customer is a golden hour customer if they meet ALL the following
# criteria:
#
# Made at least 3 orders.
#
# At least 60% of their orders are during peak hours (11:00-14:00 or
# 18:00-21:00).
#
...
# payment_method | order_rating |
# +----------+-------------+---------------------+--------------+----------------+--------------+
# | 1        | 101         | 2024-03-01 12:30:00 | 25.50        | card
# | 5            |
# | 2        | 101         | 2024-03-02 19:15:00 | 32.00        | app
# | 4            |
# | 3        | 101         | 2024-03-03 13:45:00 | 28.75        | card
# | 5            |
# | 4        | 101         | 2024-03-04 20:30:00 | 41.00        | app
# | NULL         |
# | 5        | 102         | 2024-03-01 11:30:00 | 18.50        | cash
# | 4            |
# | 6        | 102         | 2024-03-02 12:00:00 | 22.00        | card
# | 3            |
# | 7        | 102         | 2024-03-03 15:30:00 | 19.75        | cash
# | NULL         |
# | 8        | 103         | 2024-03-01 19:00:00 | 55.00        | app
# | 5            |
# | 9        | 103         | 2024-03-02 20:45:00 | 48.50        | app
# | 4            |
# | 10       | 103         | 2024-03-03 18:30:00 | 62.00        | card
# | 5            |
# | 11       | 104         | 2024-03-01 10:00:00 | 15.00        | cash
# | 3            |
# | 12       | 104         | 2024-03-02 09:30:00 | 18.00        | cash
# | 2            |
# | 13       | 104         | 2024-03-03 16:00:00 | 20.00        | card
# | 3            |
# | 14       | 105         | 2024-03-01 12:15:00 | 30.00        | app
# | 4            |
# | 15       | 105         | 2024-03-02 13:00:00 | 35.50        | app
# | 5            |
# | 16       | 105         | 2024-03-03 11:45:00 | 28.00        | card
# | 4            |
# +----------+-------------+---------------------+--------------+----------------+--------------+
#
# Output:
...
#
# Peak hour orders: 4 out of 4 (12:30, 19:15, 13:45, and 20:30 are in peak
# hours)
#
...
#
# Peak hour orders: 2 out of 3 (11:30, 12:00 are in peak hours; 15:30 is
# not)
#
...
# Total orders: 3 (at least 3)
#
# Peak hour orders: 0 out of 3 (10:00, 09:30, 16:00 all outside peak
# hours)
#
...
# Result: Golden hour customer
#
# The results table is ordered by average_rating DESC, then customer_id
# DESC.
#
...
class Solution:
    def solve(self) -> str:
        ...
        Golden-hour customers: >=3 orders, >=60% in peak windows, average rated
        score >= 4.0, and >=50% of orders rated.

        Algorithm:
        - Peak: time in [11:00,14:00) or [18:00,21:00).
        - Aggregate per customer_id; filter with HAVING; ROUND metrics.
        - ORDER BY average_rating DESC, customer_id DESC.

        Complexity: O(N) scan/group over orders.
        """
        self.sql = """
SELECT
    customer_id,
    ...
    ROUND(
        100.0 * SUM(
            CASE
                WHEN TIME(order_timestamp) >= '11:00:00'
                 AND TIME(order_timestamp) < '14:00:00'
                THEN 1
                WHEN TIME(order_timestamp) >= '18:00:00'
