...
class Solution:
    def maxTotalValue(self, nums: List[int], k: int) -> int:
        ...
        Any subarray value is at most global_max - global_min, and some
        subarray (e.g. the whole array) achieves it. Repeats are allowed, so
        pick that best value k times.
