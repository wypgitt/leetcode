...
# restaurants with veganFriendly_i set to true) or false (meaning you can
...
# from highest to lowest. For simplicity veganFriendly_i and veganFriendly take
...
class Solution:
    def filterRestaurants(
        ...
        restaurants[i]=[id,rating,veganFriendly,price,distance]. Filter by
        vegan (if flag), price, distance; sort by rating DESC then id DESC;
        return ids.

        Algorithm:
        - Filter; sort key=(-rating,-id); return ids.
