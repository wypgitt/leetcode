...
class Solution:
    def simplifyPath(self, path: str) -> str:
        ...
        Unix path simplification is stack-based. Normal directory names push
        onto the stack, '..' pops one directory if possible, and '.' or empty
        components do nothing. Joining the stack with '/' gives the canonical
        absolute path.

        Edge cases and tests:
        - Multiple slashes collapse because empty parts are ignored.
        - Leading '..' at root stays at root.
        - Names like '...' are regular directory names, not parent markers.
