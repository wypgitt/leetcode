...
class Solution:
    def inorderSuccessor(self, node: "Node") -> "Node":
        ...
        Premium. Inorder successor with parent pointers, no root given.
        If node has a right child, successor is the leftmost node in the right
        subtree. Else walk up via parent until coming from a left child.

        Algorithm:
        - If node.right: cur = node.right; while cur.left: cur = cur.left; return cur
