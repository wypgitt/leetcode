...
# Explanation:
#
# After each second, a person enters the waiting room and no person leaves
# it. Therefore, a minimum of 7 chairs is needed.
#
# Example 2:
#
# Input: s = "ELELEEL"
...
class Solution:
    def minimumChairs(self, s: str) -> int:
        ...
        Track current occupancy; chairs needed is the maximum number of people
        simultaneously present.

        Algorithm:
        - cur += 1 on 'E', cur -= 1 on 'L'; ans = max(ans, cur).
    ...
    def minimumChairs_prefix(self, s: str) -> int:
        """
        Interview explanation:
        Alternate: occupancy is a running prefix of (+1/-1); answer is max prefix.

        Algorithm:
        - Map E->+1, L->-1; return max of running sums.
