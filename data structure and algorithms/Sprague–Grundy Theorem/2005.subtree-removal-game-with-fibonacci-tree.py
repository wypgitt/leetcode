#
# @lc app=leetcode id=2005 lang=python3
#
# [2005] Subtree Removal Game with Fibonacci Tree
#
# https://leetcode.com/problems/subtree-removal-game-with-fibonacci-tree/description/
#
# algorithms
# Hard (57.97%)
# Likes:    16
...
class Solution:
    def findGameWinner(self, n: int) -> bool:
        ...
        Premium impartial game on Fibonacci tree F(n). Players alternately
        remove a nonempty subtree; last move wins. Sprague-Grundy of F(n) is 0
        iff n % 6 == 1.

        Algorithm:
        - Return whether first player wins: n % 6 != 1.
