...
# + 9 = 19
# - The planet collides with the asteroid with a mass of 19. New planet mass: 19
# + 19 = 38
...
# + 3 = 46
# - The planet collides with the asteroid with a mass of 21. New planet mass: 46
# + 21 = 67
...
# Output: false
# Explanation:
# The planet cannot ever gain enough mass to destroy the asteroid with a mass of
# 23.
...
class Solution:
    def asteroidsDestroyed(self, mass: int, asteroids: List[int]) -> bool:
        ...
        Can destroy asteroid if mass >= asteroid mass, then mass += asteroid.
        Check if all can be destroyed in some order.

        Algorithm:
        - Sort ascending; always fight smallest remaining; fail if can't.
