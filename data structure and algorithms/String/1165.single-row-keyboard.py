...
class Solution:
    def calculateTime(self, keyboard: str, word: str) -> int:
        ...
        Premium. Single-row keyboard; time = sum of absolute index moves between
        consecutive characters, starting from index 0.

        Algorithm:
        - Map char→index; walk word accumulating |pos - prev|.

        Complexity: O(|word|) time, O(1) space for 26 letters.
        """
