...
class Solution:
    def decodeAtIndex(self, s: str, k: int) -> str:
        ...
        Tape can be huge — never expand. First compute decoded length, then
        walk s backward: digits divide length; letters shrink by 1 and may hit k.

        Algorithm:
        - size grow: letter +1; digit *d.
        - From end: k%=size; if letter and k==0 return it; size//=d or size-=1.
