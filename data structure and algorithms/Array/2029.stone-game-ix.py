...
# and each stone has an associated value. You are given an integer array stones,
# where stones[i] is the value of the i^th stone.
#
...
class Solution:
    def stoneGameIX(self, stones: List[int]) -> bool:
        ...
        Stones with values mod 3 in {0,1,2}. Remove stone so running sum %3 !=0;
        cannot move loses. Alice wins if she has a winning strategy.

        Algorithm:
        - Count c0,c1,c2. If c0 even: Alice wins iff c1>0 and c2>0.
          If c0 odd: Alice wins iff |c1-c2| > 2.
