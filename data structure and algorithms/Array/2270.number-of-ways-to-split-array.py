...
# The second part is [-8,7], and its sum is -1. Since 14 >= -1, i = 1 is a valid
# split.
...
class Solution:
    def waysToSplitArray(self, nums: List[int]) -> int:
        ...
        Count splits i (0..n-2) with sum(0..i) >= sum(i+1..n-1).

        Algorithm:
        - Total sum; running left; compare left >= total-left.
