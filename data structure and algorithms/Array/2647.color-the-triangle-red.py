...
#
# LeetCode submission
# `from typing import List` inside the LC code section markers.
#
...
class Solution:
    def colorRed(self, n: int) -> List[List[int]]:
        ...
        Seed the fewest unit triangles so that “≥2 red neighbors ⇒ turn red” eventually
        colors the whole subdivided equilateral triangle; return any optimal seed set.

        Algorithm:
        - Constructive 4-phase pattern walking rows from n down to 2: seed odd columns,
          then (i,2), then odds from 3, then (i,1); advance phase mod 4 each row.
        - Always include the apex [1, 1].
