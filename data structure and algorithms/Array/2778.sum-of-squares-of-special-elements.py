...
# nums[1] + nums[2] * nums[2] + nums[4] * nums[4] = 1 * 1 + 2 * 2 + 4 * 4 = 21.
#
# Example 2:
#
...
class Solution:
    def sumOfSquares(self, nums: List[int]) -> int:
        ...
        Special element: 1-indexed i divides n = len(nums). Return sum of squares
        of special elements.

        Algorithm:
        - Enumerate i=1..n; if n % i == 0 add nums[i-1]^2.
