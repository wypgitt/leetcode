...
#
# numberOfUnitsPerBox_i_ is the number of units in each box of the type i.
#
...
class Solution:
    def maximumUnits(self, boxTypes: List[List[int]], truckSize: int) -> int:
        ...
        Maximize total units on truck of capacity truckSize boxes. Greedy: take
        boxes with most units-per-box first.

        Algorithm:
        - Sort boxTypes by units descending; greedily take min(count, remaining).
