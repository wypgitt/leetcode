...
#
# base[n] = [1, 2, ..., n - 1, n, n] (in other words, it is an array of length n
# + 1 which contains 1 to n - 1 exactly once, plus two occurrences of n). For
...
# for which this array could be a permutation of base[n], is n = 3. However,
# base[3] has four elements but array nums has three. Therefore, it can not be a
...
# Output: true
# Explanation: Since the maximum element of the array is 3, the only candidate n
# for which this array could be a permutation of base[n], is n = 3. It can be
...
# Input: nums = [1, 1]
# Output: true
# Explanation: Since the maximum element of the array is 1, the only candidate n
# for which this array could be a permutation of base[n], is n = 1. It can be
...
# Output: false
# Explanation: Since the maximum element of the array is 4, the only candidate n
# for which this array could be a permutation of base[n], is n = 4. However,
...
class Solution:
    def isGood(self, nums: List[int]) -> bool:
        ...
        Base[n] is permutation of [1,2,...,n-1,n,n]. Check if nums is a permutation
        of base[n] for n = len(nums)-1.

        Algorithm:
        - Compare sorted(nums) to [1..n-1] + [n, n].
