#
# @lc app=leetcode id=3118 lang=python3
#
...
# purchases on a particular Friday by Premium or VIP members, it should be
# considered as 0.
#
# Return the result table ordered by week of the month,  and membership in
# ascending order.
#
...
# there were no purchases by Premium members that Friday, the output shows
# 0 for Premium members.
#
...
# 2023-11-24, involving one Premium member purchase of $5,117 and VIP
# member purchases totaling $14,933 ($9,692 from one and $5,241 from
# another).
#
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: Nov 2023 Fridays; total spend by Premium and VIP (0 if none).
        Order by week_of_month, membership ASC.

        Algorithm:
        - CTE of 4 Fridays × {Premium, VIP}; LEFT JOIN Users/Purchases; SUM.
