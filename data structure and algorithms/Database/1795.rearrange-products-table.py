#
# @lc app=leetcode id=1795 lang=python3
#
...
class Solution:
    def solve(self) -> str:
        ...
        Products wide table (product_id, store1, store2, store3) → long format
        (product_id, store, price), dropping NULL prices.

        Algorithm:
        - UNION ALL three SELECT product_id, 'storeX', storeX WHERE storeX IS NOT NULL.
