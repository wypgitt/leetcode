#
# @lc app=leetcode id=3564 lang=python3
#
...
# that season. If there is a tie, select the category with the highest
# total revenue (quantity × price). If there is still a tie, return the
...
#
# Most popular: Kitchen with highest total quantity (3) and highest
# revenue ($54.00)
#
# Summer (Jun, Jul, Aug):
#
...
# Winter (Dec, Jan, Feb):
#
# Apparel: 9 items sold (5 Jackets in Jan, 4 Jeans in Jan), revenue
# $110.00
#
...
#
# Most popular: Apparel with highest total quantity (9) and highest
# revenue ($110.00)
#
...
class Solution:
    def solve(self) -> str:
        ...
        Map sale months to seasons, aggregate quantity and revenue per
        (season, category), then pick the best category per season by
        quantity DESC, revenue DESC, category ASC.

        Algorithm:
        - JOIN sales↔products; CASE month → season.
        - GROUP BY season, category; ROW_NUMBER / RANK for top category.
        - ORDER BY season ASC.
