#
# @lc app=leetcode id=3808 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"reactions\":[\"user_id\",\"content_id\",\"reaction\"]},\"rows\":{\"reactions\":[[1,101,\"like\"],[1,102,\"like\"],[1,103,\"like\"],[1,104,\"wow\"],[1,105,\"like\"],[2,201,\"like\"],[2,202,\"wow\"],[2,203,\"sad\"],[2,204,\"like\"],[2,205,\"wow\"],[3,301,\"love\"],[3,302,\"love\"],[3,303,\"love\"],[3,304,\"love\"],[3,305,\"love\"]]}}"
#
#
# Table: reactions
#
...
#
# The Results table is ordered by reaction_ratio in descending order, then
...
class Solution:
    def solve(self) -> str:
        ...
        Users with >=5 reactions whose dominant reaction is >=60% of total.

        Algorithm:
        - Aggregate (user_id, reaction) counts.
        - Keep users with SUM(cnt) >= 5 and MAX(cnt)/SUM(cnt) >= 0.60.
        - Join back for dominant_reaction; order by ratio DESC, user_id ASC.

        Complexity: O(R) over reaction rows.
        """
        self.sql = """
WITH
    t AS (
