#
# @lc app=leetcode id=3246 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"TeamStats\":[\"team_id\",\"team_name\",\"matches_played\",\"wins\",\"draws\",\"losses\"]},\"rows\":{\"TeamStats\":[[1,\"Manchester City\",10,6,2,2],[2,\"Liverpool\",10,6,2,2],[3,\"Chelsea\",10,5,3,2],[4,\"Arsenal\",10,4,4,2],[5,\"Tottenham\",10,3,5,2]]}}"
#
#
# Table: TeamStats
#
...
# Explanation:
#
# Manchester City and Liverpool both have 20 points (6 wins * 3 points + 2
# draws * 1 point), so they share position 1.
#
...
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL: TeamStats -> points = 3*wins + draws, dense ranking by
        points (ties share position). Order by points DESC, team_name ASC.

        Algorithm:
        - RANK() OVER (ORDER BY points DESC) for position.
