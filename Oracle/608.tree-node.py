#
# @lc app=leetcode id=608 lang=python3
#
# [608] Tree Node
#
...
# Each row of this table contains information about the id of a node and the id
# of its parent node in a tree.
...
class Solution:
    def solve(self) -> str:
        ...
        Classify each tree node as Root / Inner / Leaf from parent pointers.

        Algorithm:
        - Root: p_id IS NULL.
        - Inner: appears as some other node's p_id.
        - Else Leaf.
