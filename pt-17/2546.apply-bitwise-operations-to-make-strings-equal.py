...
class Solution:
    def makeStringsEqual(self, s: str, target: str) -> bool:
        ...
        Op on bits (a,b)->(a|b, a^XOR b). Can we turn s into target?

        Algorithm:
        - Presence of at least one '1' is preserved (all-zero stays all-zero;
          any 1 can be moved/copied among positions). Equal iff both have a 1
          or both are all zeros: ("1" in s) == ("1" in target).
