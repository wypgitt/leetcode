#
# @lc app=leetcode id=2072 lang=python3
#
...
# Testcase Example:  "{\"headers\":{\"NewYork\":[\"student_id\",\"score\"],\"California\":[\"student_id\",\"score\"]},\"rows\":{\"NewYork\":[[1,90],[2,87]],\"California\":[[2,89],[3,88]]}}"
#
#
# Table: NewYork
#
...
# Each row contains information about the score of one student from New
# York University in an exam.
#
# Table: California
#
# +-------------+------+
...
# +-----------+
# Explanation:
# Both New York University and California University have 1 excellent
# student.
#
# @lc code=start
class Solution:
    def solve(self) -> str:
        ...
        Premium SQL. NewYork(student_id, score), California(student_id, score).
        Compare counts of students with score >= 90; return 'New York
        University', 'California University', or 'No Winner'.

        Algorithm:
        - COUNT IF score>=90 for each; CASE comparison.
