...
class Solution:
    def minSwaps(self, nums: List[int]) -> int:
        ...
        Circular array; min swaps to group all 1s together.

        Algorithm:
        - Let ones = total 1s. Sliding window of size ones on doubled array;
          maximize 1s in window; swaps = ones - max_ones_in_window.
