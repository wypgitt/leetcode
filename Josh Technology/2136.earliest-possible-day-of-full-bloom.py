...
# day 4.
# On days 0 and 3, plant the 1^st seed. The seed grows for 1 full day and blooms
# on day 5.
# On days 2, 4, and 5, plant the 2^nd seed. The seed grows for 2 full days and
# blooms on day 8.
# On days 6 and 7, plant the 3^rd seed. The seed grows for 1 full day and blooms
# on day 9.
# Thus, on day 9, all the seeds are blooming.
#
# Example 3:
...
class Solution:
    def earliestFullBloom(self, plantTime: List[int], growTime: List[int]) -> int:
        ...
        Plant seeds sequentially (one at a time); each then grows. Minimize day
        when all have bloomed. Bloom day of a seed = finish_plant + growTime.

        Algorithm:
        - Plant in decreasing growTime order so long growers start earlier.
        - Track current plant finish time; max over finish+grow.
